Vue.component('cart', {
    ...
    template: `
        <div class="cart">
            <button class="btn-cart menu_2_item" type="button" @click="showCart = !showCart">
        ...
        <path
            ...
            <div class="cart-block" v-show="showCart">
                ...
                <button class="cart-block_button">
                    <a href="cart.html">Перейти в карзину</a>
                </button class="cart-block_button">
            </div>
        </div>`
});
...
Vue.component('cart-item', {
    props: ['cartItem', 'img'],
    template: `
                <div class="cart-item cart_block width">
                <div class="tovar">
